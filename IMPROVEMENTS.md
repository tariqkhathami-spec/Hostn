...
| I62 | 2026-04-08 | `/listings` — List picker popover on heart click for saving to specific lists | AMS | Heart click opens popover with all user's lists as checkboxes; check/uncheck to add/remove from any list; "New list" button creates list + adds property in one step; click-outside to dismiss; if already wishlisted, heart click removes from all lists | Done |
